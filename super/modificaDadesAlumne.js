function revisaModificaDadesAlumne(){
	var nom = document.formulariModificarDadesAlumnes.nom.value;
	var cognom = document.formulariModificarDadesAlumnes.cognom.value;
	var email = document.formulariModificarDadesAlumnes.mail.value;
	var telefon = document.formulariModificarDadesAlumnes.telefon.value;

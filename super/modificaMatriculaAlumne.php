...
<HTML>
	<HEAD>
		...
		<script src="modificaMatriculaAlumne.js"> </script>
		<?php menu_consultes($usuari); ?>
	</HEAD>
	
	<BODY>
		<h1> Modifica Alumnes de l'Institut - INS Esteve Terradas i Illa </h1>
			<form name='formulariModificarMatriculaAlumnes' id='formulari' action='modificaMatriculaAlumne.php' method='post' onsubmit=''>
				...
				<?php
					...
					if(isset($_POST["obteAlumne"])){
						...
						if(!empty($_POST["alumnes"])){
							...
							/*for($i=0;$i<count($_SESSION['diccionari']);$i++){
								echo "Contingut de la VAR: ".$_SESSION['diccionari'][$i];
							}*/
								...
								foreach($fila as $valor){
									...
									if($columna === 0){
										echo '
											...
											<td style="text-align:center;"> <input type="text" name="nom" value="'.$valor.'"> </td>
										';
									}else if($columna === 1){
										echo '
										...
										echo '
											...
											<td style="text-align:center;"> <input type="text" name="mail" value="'.$valor.'"> </td>
										';
									}else if($columna === 3){
										echo '
											<td style="text-align:center;"> Telèfon de l\'Alumne: </td>
											<td style="text-align:center;"> <input type="text" name="telefon" value="'.$valor.'"> </td>
										';
									}
									$columna = $columna + 1;
									echo "</tr>";
		...
		<?php
			...
			if(isset($_POST["tancaSessio"])){
				...
				$resultat = modificaDadesAlumne($idAlumne, $nomAlumne,$cognomAlumne,$correu,$telefon);
